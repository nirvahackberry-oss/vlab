...
import { Trash2, UserX, UserCheck, Mail, Database } from 'lucide-react'
...
import { UsersMultiCreditsDialog } from './users-multi-credits-dialog'
...
export function DataTableBulkActions<TData>({
  ...
  return (
    <>
      ...
      <UsersMultiCreditsDialog
        table={table}
        open={showCreditsConfirm}
        onOpenChange={setShowCreditsConfirm}
      />
    </>
  )
}
